...
// Enricher adds or modifies attributes for log records before they reach the
// [Writer]. Implementations may read [context.Context] (for example request ID
// or user) and call [RecordBuilder.AddAttr] / [RecordBuilder.AddAttrs]. Use
// [NewContextEnricher] with [FromContext] getters for typed context keys, or
// [NewSourceEnricher] for caller file/line.
...
// EnricherFunc adapts a function to [Enricher], avoiding a new named type for
// one-off hooks.
//
// Example:
//
